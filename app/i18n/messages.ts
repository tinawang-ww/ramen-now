...
const zh = {
  ...
  'reviewForm.photoLabel': '照片（可選）',
  'reviewForm.addPhoto': '＋ 加一張照片',
  'reviewForm.photoUploading': '照片上傳中…',
  'reviewForm.photoTooLarge': '照片太大，請選 5MB 以內的。',
  'reviewForm.photoFailed': '照片上傳失敗，請再試一次',
  'reviewForm.photoDisabled': '照片功能暫時停用，文字還是收得到。',
  'reviewForm.removePhoto': '移除照片',
  ...
  'me.stamps': '蓋章簿',
  'me.stampsHint': '回報過的店，一家一枚章。第 3 次多一圈，第 10 次鍍金。',
  'me.regular': '常客',
  'me.shareStamps': '分享蓋章簿',
  'me.sharingStamps': '準備中…',
  'me.copyStamps': '複製圖片',
  'me.copyingStamps': '複製中…',
  'me.stampsCopied': '已複製蓋章簿圖片，直接貼上就好！',
  'me.copyStampsFailed': '複製失敗，請再試一次',
  'me.stampsDownloaded': '已下載蓋章簿圖片，貼到限動吧！',
  'me.shareStampsFailed': '分享失敗，請再試一次',
  'me.shareCardShops': '{count} 家店',
  'me.shareCardMore': '還有 {count} 家',
...
const en = {
  ...
  'reviewForm.photoLabel': 'Photo (optional)',
  'reviewForm.addPhoto': '＋ Add a photo',
  'reviewForm.photoUploading': 'Uploading photo…',
  'reviewForm.photoTooLarge': 'Photo too large — keep it under 5MB.',
  'reviewForm.photoFailed': 'Photo upload failed — please try again.',
  'reviewForm.photoDisabled': 'Photos are off for now — the words still land.',
  'reviewForm.removePhoto': 'Remove photo',
  ...
  'me.stamps': 'Stamp book',
  'me.stampsHint': 'One stamp per shop. A second ring at ×3, gold at ×10.',
  'me.regular': 'Regular',
  'me.shareStamps': 'Share my stamp book',
  'me.sharingStamps': 'Preparing…',
  'me.copyStamps': 'Copy image',
  'me.copyingStamps': 'Copying…',
  'me.stampsCopied': 'Stamp book image copied — just paste it!',
  'me.copyStampsFailed': 'Couldn’t copy — please try again.',
  'me.stampsDownloaded': 'Stamp book image downloaded — post it!',
  'me.shareStampsFailed': 'Couldn’t share — please try again.',
  'me.shareCardShops': '{count} shops',
  'me.shareCardMore': 'and {count} more',
